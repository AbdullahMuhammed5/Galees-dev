...
@Component({
  selector: 'app-reviewsAdmin',
  templateUrl: './reviewsAdmin.component.html',
  styleUrls: ['./reviewsAdmin.component.scss']
})
export class ReviewsAdminComponent implements OnInit {
  ...
  ngOnInit() {
    this.http.get('http://localhost:8000/reviews').subscribe(
      res => {
        console.log(res);
        this.profiles = res;
